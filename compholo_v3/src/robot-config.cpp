...
motor LFM = motor(PORT20, ratio18_1, true);
motor RFM = motor(PORT9, ratio18_1, false);
motor LBM = motor(PORT19, ratio18_1, false);
motor RBM = motor(PORT10, ratio18_1, true);
motor Lintake = motor(PORT15, ratio18_1, false);
motor Rintake = motor(PORT8, ratio18_1, true);
motor Rlift = motor(PORT5, ratio18_1, false);
motor Llift = motor(PORT14, ratio18_1, true);
